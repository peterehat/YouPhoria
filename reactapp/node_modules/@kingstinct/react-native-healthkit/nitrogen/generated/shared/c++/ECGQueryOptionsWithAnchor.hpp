...
namespace margelo::nitro::healthkit {
  ...
  public:
    ...
    explicit ECGQueryOptionsWithAnchor(bool includeVoltages, std::optional<std::string> anchor, std::optional<std::variant<PredicateWithUUID, PredicateWithUUIDs, PredicateWithMetadataKey, PredicateWithStartAndEnd, PredicateFromWorkout, FilterForSamplesAnd, FilterForSamplesOr>> filter, std::optional<double> limit): includeVoltages(includeVoltages), anchor(anchor), filter(filter), limit(limit) {}
  };
