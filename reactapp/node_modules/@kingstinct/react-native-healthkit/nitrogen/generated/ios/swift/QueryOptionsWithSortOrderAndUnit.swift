///
/// QueryOptionsWithSortOrderAndUnit.swift
...
/**
 * Represents an instance of `QueryOptionsWithSortOrderAndUnit`, backed by a C++ struct.
 */
public typealias QueryOptionsWithSortOrderAndUnit = margelo.nitro.healthkit.QueryOptionsWithSortOrderAndUnit

public extension QueryOptionsWithSortOrderAndUnit {
  private typealias bridge = margelo.nitro.healthkit.bridge.swift

  /**
   * Create a new instance of `QueryOptionsWithSortOrderAndUnit`.
   */
  init(unit: String?, ascending: Bool?, filter: Variant_PredicateWithUUID_PredicateWithUUIDs_PredicateWithMetadataKey_PredicateWithStartAndEnd_PredicateFromWorkout_FilterForSamplesAnd_FilterForSamplesOr?, limit: Double?) {
  ...
  var unit: String? {
    ...
    @inline(__always)
    set {
      self.__unit = { () -> bridge.std__optional_std__string_ in
